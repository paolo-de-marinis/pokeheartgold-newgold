...
typedef char Ov83SummaryPartyOffsetCheck[offsetof(Ov83OpponentSummaryStatePrefix, party) == 0x55C ? 1 : -1];
typedef char Ov83SummaryOffsetCheck[offsetof(Ov83OpponentSummaryStatePrefix, summary) == 0x5BC ? 1 : -1];
