...
// The box list's cursor, moved with the D-pad: 0 to 5 are the six boxes of
// the row, 8 is the way out. Moving right off the last of the row turns to
// the next box, and left off the first to the one before.
