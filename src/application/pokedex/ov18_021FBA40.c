...
// Where the type search's buttons are touched: the seventeen types and
// "----" four to a row, then OK and Cancel. A touch answers the button's
// index, which ov18_021FBB94 moves the cursor between.
