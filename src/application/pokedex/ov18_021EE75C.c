...
void ov18_021EE75C(PokedexAppData *pokedexApp, u32 species, int windowId) {
    ...
    if (species != SPECIES_NONE) {
        BufferIntegerAsString(pokedexApp->msgFormat, 0, Pokedex_ConvertToCurrentDexNo(pokedexApp->unk_1858, species), DEX_NUMBER_DIGITS, PRINTING_MODE_LEADING_ZEROS, TRUE);
