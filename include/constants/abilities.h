...
#define ABILITY_COMPETITIVE          142
#define ABILITY_CURSED_BODY          143
#define ABILITY_SHARPNESS            144
#define ABILITY_NEUTRALIZING_GAS     145
#define ABILITY_WIND_RIDER           146
#define ABILITY_EARTH_EATER          147
