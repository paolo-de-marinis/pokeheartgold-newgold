...
static u32 BattlerMoveWeatherAt(BattleSystem *bs, BattleContext *ctx, int battlerIdAttacker, int battlerId) { (void)bs; (void)ctx; (void)battlerIdAttacker; (void)battlerId; return 0; }
