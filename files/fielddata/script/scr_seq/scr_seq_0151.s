...
_NEWGOLD_BUG_CONTEST_PRIZE:
	;; New Gold gives out evolution items rather than the berries and
	;; ribbons of the original, graded by where the player placed.
	;; JudgeBugContest has already left the placing in VAR_TEMP_x4000 and
	;; the original prize in VAR_TEMP_x4001; only the prize is replaced.
	Compare VAR_TEMP_x4000, 0
	GoToIfEq _NEWGOLD_PRIZE_FIRST
	Compare VAR_TEMP_x4000, 1
	GoToIfEq _NEWGOLD_PRIZE_SECOND
	Compare VAR_TEMP_x4000, 2
	GoToIfEq _NEWGOLD_PRIZE_THIRD
	GoTo _NEWGOLD_PRIZE_CONSOLATION

_NEWGOLD_PRIZE_FIRST:
	;; First: one of five rare evolution items, evenly.
	Random VAR_SPECIAL_RESULT, 5
	Compare VAR_SPECIAL_RESULT, 0
	GoToIfEq _NEWGOLD_PRIZE_REAPER_CLOTH
	Compare VAR_SPECIAL_RESULT, 1
	GoToIfEq _NEWGOLD_PRIZE_ELECTIRIZER
	Compare VAR_SPECIAL_RESULT, 2
	GoToIfEq _NEWGOLD_PRIZE_MAGMARIZER
	Compare VAR_SPECIAL_RESULT, 3
	GoToIfEq _NEWGOLD_PRIZE_DUBIOUS_DISC
	GoTo _NEWGOLD_PRIZE_PEAT_BLOCK

_NEWGOLD_PRIZE_SECOND:
	;; Second: a wider pool of ten, evenly.
	Random VAR_SPECIAL_RESULT, 10
	Compare VAR_SPECIAL_RESULT, 0
	GoToIfEq _NEWGOLD_PRIZE_SHINY_STONE
	Compare VAR_SPECIAL_RESULT, 1
	GoToIfEq _NEWGOLD_PRIZE_DUSK_STONE
	Compare VAR_SPECIAL_RESULT, 2
	GoToIfEq _NEWGOLD_PRIZE_DAWN_STONE
	Compare VAR_SPECIAL_RESULT, 3
	GoToIfEq _NEWGOLD_PRIZE_RAZOR_CLAW
	Compare VAR_SPECIAL_RESULT, 4
	GoToIfEq _NEWGOLD_PRIZE_DRAGON_SCALE
	Compare VAR_SPECIAL_RESULT, 5
	GoToIfEq _NEWGOLD_PRIZE_PRISM_SCALE
	Compare VAR_SPECIAL_RESULT, 6
	GoToIfEq _NEWGOLD_PRIZE_UPGRADE
	Compare VAR_SPECIAL_RESULT, 7
	GoToIfEq _NEWGOLD_PRIZE_DEEPSEATOOTH
	Compare VAR_SPECIAL_RESULT, 8
	GoToIfEq _NEWGOLD_PRIZE_DEEPSEASCALE
	GoTo _NEWGOLD_PRIZE_PROTECTOR

_NEWGOLD_PRIZE_THIRD:
	;; Third: what a trade would otherwise be needed for.
	SetVar VAR_TEMP_x4001, ITEM_LINKING_CORD
	Return

_NEWGOLD_PRIZE_CONSOLATION:
	;; Anywhere else: one ordinary evolution stone.
	Random VAR_SPECIAL_RESULT, 7
	Compare VAR_SPECIAL_RESULT, 0
	GoToIfEq _NEWGOLD_PRIZE_SUN_STONE
	Compare VAR_SPECIAL_RESULT, 1
	GoToIfEq _NEWGOLD_PRIZE_MOON_STONE
	Compare VAR_SPECIAL_RESULT, 2
	GoToIfEq _NEWGOLD_PRIZE_FIRE_STONE
	Compare VAR_SPECIAL_RESULT, 3
	GoToIfEq _NEWGOLD_PRIZE_THUNDER_STONE
	Compare VAR_SPECIAL_RESULT, 4
	GoToIfEq _NEWGOLD_PRIZE_WATER_STONE
	Compare VAR_SPECIAL_RESULT, 5
	GoToIfEq _NEWGOLD_PRIZE_LEAF_STONE
	GoTo _NEWGOLD_PRIZE_ICE_STONE

_NEWGOLD_PRIZE_REAPER_CLOTH:
	SetVar VAR_TEMP_x4001, ITEM_REAPER_CLOTH
	Return

_NEWGOLD_PRIZE_ELECTIRIZER:
	SetVar VAR_TEMP_x4001, ITEM_ELECTIRIZER
	Return

_NEWGOLD_PRIZE_MAGMARIZER:
	SetVar VAR_TEMP_x4001, ITEM_MAGMARIZER
	Return

_NEWGOLD_PRIZE_DUBIOUS_DISC:
	SetVar VAR_TEMP_x4001, ITEM_DUBIOUS_DISC
	Return

_NEWGOLD_PRIZE_PEAT_BLOCK:
	SetVar VAR_TEMP_x4001, ITEM_PEAT_BLOCK
	Return

_NEWGOLD_PRIZE_SHINY_STONE:
	SetVar VAR_TEMP_x4001, ITEM_SHINY_STONE
	Return

_NEWGOLD_PRIZE_DUSK_STONE:
	SetVar VAR_TEMP_x4001, ITEM_DUSK_STONE
	Return

_NEWGOLD_PRIZE_DAWN_STONE:
	SetVar VAR_TEMP_x4001, ITEM_DAWN_STONE
	Return

_NEWGOLD_PRIZE_RAZOR_CLAW:
	SetVar VAR_TEMP_x4001, ITEM_RAZOR_CLAW
	Return

_NEWGOLD_PRIZE_DRAGON_SCALE:
	SetVar VAR_TEMP_x4001, ITEM_DRAGON_SCALE
	Return

_NEWGOLD_PRIZE_PRISM_SCALE:
	SetVar VAR_TEMP_x4001, ITEM_PRISM_SCALE
	Return

_NEWGOLD_PRIZE_UPGRADE:
	SetVar VAR_TEMP_x4001, ITEM_UPGRADE
	Return

_NEWGOLD_PRIZE_DEEPSEATOOTH:
	SetVar VAR_TEMP_x4001, ITEM_DEEPSEATOOTH
	Return

_NEWGOLD_PRIZE_DEEPSEASCALE:
	SetVar VAR_TEMP_x4001, ITEM_DEEPSEASCALE
	Return

_NEWGOLD_PRIZE_PROTECTOR:
	SetVar VAR_TEMP_x4001, ITEM_PROTECTOR
	Return

_NEWGOLD_PRIZE_SUN_STONE:
	SetVar VAR_TEMP_x4001, ITEM_SUN_STONE
	Return

_NEWGOLD_PRIZE_MOON_STONE:
	SetVar VAR_TEMP_x4001, ITEM_MOON_STONE
	Return

_NEWGOLD_PRIZE_FIRE_STONE:
	SetVar VAR_TEMP_x4001, ITEM_FIRE_STONE
	Return

_NEWGOLD_PRIZE_THUNDER_STONE:
	SetVar VAR_TEMP_x4001, ITEM_THUNDERSTONE
	Return

_NEWGOLD_PRIZE_WATER_STONE:
	SetVar VAR_TEMP_x4001, ITEM_WATER_STONE
	Return

_NEWGOLD_PRIZE_LEAF_STONE:
	SetVar VAR_TEMP_x4001, ITEM_LEAF_STONE
	Return

_NEWGOLD_PRIZE_ICE_STONE:
