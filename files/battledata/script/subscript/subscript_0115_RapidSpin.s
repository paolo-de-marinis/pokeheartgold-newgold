...
// subscript, run once the move has hit, so the raise is put here, ahead of the
// clearing as it is there, and both wait on the user's HP as the reference's
// clearing does. The rise is an indirect one: nothing is said at the top.
_000:
