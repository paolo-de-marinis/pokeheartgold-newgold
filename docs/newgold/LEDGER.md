...
| Abilities | 247 do something — 123 retail effects and 124 added; the other 72 are a name and a species field, and `test_ability_effects.py` counts them down | 🟠 247 / 319 |
