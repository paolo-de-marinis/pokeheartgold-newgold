...
Implementation         █████████████████████████████████████████████████░  98%
Verified in play       ███████░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░  14%
Audit rows closed      ████████████████████████████████████████████░░░░░░  89%

Audit: 43 of 397 rows in docs/newgold/AUDIT-*.md still open.
...
| Moves | 131 effect scripts, 59 subscripts, 62 side-effect table slots, and the three "X used Y!" lines each move reads from bank 3. Until 2026-09-23 that bank stopped at Shadow Force, so any move past 467 stopped the battle the moment it was used -- Morty's Misdreavus found it with Hex. 903 of the 905 in scope do something: the seventh round gave 54 of the moves the engine leaves unimplemented their effect and the eighth Ally Switch and the three Pledges; Sky Drop and Revival Blessing are an open audit row, and the 18 Max moves are Dynamax's, out of scope and out of the count | 🟠 903 / 905 |
| Abilities | all 318 do something — 123 retail effects and 195 added. The last 31 came in the fifth round, each from its Pokémon Central page where the reference leaves it empty (Paolo, 2026-09-23: none stays empty): the primal weathers, Parental Bond, Illusion, Emergency Exit and Wimp Out, Dancer, the Terapagos and Ogerpon abilities -- the Tera forms being species, they act as the form comes in -- Mega Sol, Shields Down, Battle Bond and the ally and switch-in abilities. The 319th constant, TEMP4, is a slot the engine reserved and named "Placeholder", carried by no species, and `test_ability_effects.py` counts it apart. `PENDING` is empty since the eighth round wrote Commander (981ec26bd, after 28f300daa): in a double battle Tatsugiri goes into Dondozo's mouth, out of every move's reach, Dondozo's five stats rise two stages, neither can leave or be forced out, and Order Up raises a stat by Tatsugiri's form (000e5e360). It had stood there since the seventh round, when a block list stopped counting as an ability's reading (acc7c51ae); Gulp Missile and Poison Puppeteer, which had passed the same way, do what Pokemon Central says (a76cef294, 66281a56e). None of the 31, nor Commander, has been seen on an emulator: the evidence is host tests and the built scripts | ✅ 318 / 318 |
